...
- 当用户打开新的空标签页时, 既是插件首页, 随后获得用户授权, 分配并保存随机ID至浏览器扩展, 并通过 浏览器扩展 导出用户的浏览器收藏夹到服务端 .
- 多用户通过口令（hash值）, 加入共同的小组, 且共享小组内所有成员的收藏夹 .
...
阅读我们的 [贡献指南](https://ant.design/docs/react/contributing) 让我们一起构建一个更好的 **fmark**

我们欢迎所有的贡献 , 请首先阅读我们的 [CONTRIBUTING.md](https://github.com/ant-design/ant-design/blob/master/.github/CONTRIBUTING.md) , 
而且你可以在 [pull requests](https://github.com/ant-design/ant-design/pulls) 
或者[GitHub issues](https://github.com/ant-design/ant-design/issues). 
提交任何想法 ,
