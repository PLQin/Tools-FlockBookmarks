<p align="center">
  <a href="https://github.com/PLQin/Tools-FlockBookmarks">
    <img width="200" src="https://raw.githubusercontent.com/PLQin/Tools-FlockBookmarks/master/logo.png">
  </a>
</p>
...
- The plugin is based on the Chrome browser. The search home page is referenced with Chrome.
- when the user opens a new empty TAB, it is the first page of the plug-in, then obtains the user authorization, assigns and saves the random ID to the browser extension, and exports the user's browser favorites to the server through the browser extension.
- multiple users join a common group by password (hash value) and share the favorites of all members in the group.

## 🖥 Environment Support


| [<img src="https://p0.ssl.qhmsg.com/t0183d516d5cc2b569c.png" alt="IE / Edge" width="24px" height="24px" />](https://browser.360.cn/ee/)</br>360 极速     |     [<img src="https://raw.githubusercontent.com/alrra/browser-logos/master/src/chrome/chrome_48x48.png" alt="Chrome" width="24px" height="24px" />](http://godban.github.io/browsers-support-badges/)</br>Chrome | 
| --------- | --------- |
...
and let's build a better **fmark** together.

We welcome all contributions. Please read our 
[CONTRIBUTING.md](https://github.com/ant-design/ant-design/blob/master/.github/CONTRIBUTING.md) first. 
You can submit any ideas as [pull requests](https://github.com/ant-design/ant-design/pulls) 
or as [gitHub issues](https://github.com/ant-design/ant-design/issues) 
and have a good time! :)




[![让我们为这个存储库提供一份力量](https://issuehunt.io/static/embed/issuehunt-button-v1.svg)](https://issuehunt.io/repos/34526884)
